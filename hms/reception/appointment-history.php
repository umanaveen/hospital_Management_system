...
if(isset($_GET['cancel']))
		  {
mysqli_query($con,"update patient_appoinment set doctorStatus='0' where id ='".$_GET['id']."'");
...
<html lang="en">
	<head>
		<title>Reception | Appointment History</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Reception  | Appointments</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Reception </span>
