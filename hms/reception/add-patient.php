...
//$sql=mysqli_query($con,"insert into users(Doctorspecialization,fullName,PatientContno,email,password,gender,address,state,city)values('$Doctorspecialization','$patname','$patcontact','$patemail','$password','$gender','$pataddress','$State','$Country')");
