...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Nomiation View</h1>
</div>
<ol class="breadcrumb">
<li>
<span>Nomiation</span>
...
<div class="row">
<div class="col-md-12">
<h5 class="over-title margin-bottom-15">Manage <span class="text-bold">Nomiation</span></h5>
...
<?php
//$docid=$_SESSION['id'];
$sql=mysqli_query($con,"SELECT * FROM `nominations`");
$cnt=1;
