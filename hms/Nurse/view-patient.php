...
$query.=mysqli_query($con, "insert   tblmedicalhistory(PatientID,Doctorspecialization,doctorId,Visit,Complint,BloodPressure,BloodSugar,Weight,height,Temperature,Past_medical_history)
value('$vid','$specilization','$doctorid','$visit','$Complints','$bp','$bs','$weight','$Height','$temp','$Past_medical')");
if ($query) {
...
<?php
                    $vid=$_GET['viewid'];
                    $ret=mysqli_query($con,"select * from patient_appoinment where ID='$vid'");
$cnt=1;
...
<th>Patient Register  Date/ Register Time</th>
...
<table class="table table-striped table-bordered"  id="articleList1" style="border:1px solid #ccc;  ">
<tr align="center">
<th colspan="11" style="font-size:20px;color:blue">Medical History</th> 
</tr>
<tr>
<th>#</th>
<th>Visit</th>
...
<td>
<input name="visit" placeholder="visit" class="form-control wd-450" required="true"></td>
</tr>     
<tr>
<th>General Complints :</th>
<td>
<input name="Complints" placeholder="Complints" class="form-control wd-450" required="true"></td>
</tr>     
...
<th>Past Medical History :</th>
<td>
<textarea name="Past_medical" placeholder="Enter the past medical History" rows="12" cols="14" class="form-control wd-450" required="true"></textarea></td>
</tr>  
