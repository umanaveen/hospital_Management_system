...
$sql=mysqli_query($con,"Update nurse set name='$name',username='$username',password='$password', where id='".$_SESSION['id']."'");
if($sql)
{
						...
						<div class="container-fluid container-fullw bg-white">
							<div class="row">
								<div class="col-md-12">
									...
									<?php $sql=mysqli_query($con,"select * from nurse where username='".$_SESSION['dlogin']."'");
