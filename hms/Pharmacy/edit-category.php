...
$sql=mysqli_query($con,"Update category set name='$Branch_name' where id='$did'");
if($sql)
{
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Pharmacy | Edit Category Details</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Pharmacy</span>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Edit Category info</h5>
												</div>
												<div class="panel-body">
									<?php $sql=mysqli_query($con,"select * from category where id='$did'");
