...
if(isset($_GET['del']))
		  {
		          mysqli_query($con,"delete from nurse where id = '".$_GET['id']."'");
						...
						<div class="container-fluid container-fullw bg-white">
								...
								<?php echo htmlentities($_SESSION['msg']="");?></p>	
									<table class="table table-striped table-bordered" id="example1">
										...
										<tbody>
<?php
$sql=mysqli_query($con,"select * from nurse");
$cnt=1;
...
?>
											...
											<tr>
												...
												<td><?php echo $row['nuspecrseialization'];?>
												<td><?php echo $row['name'];?>
												<td><?php echo $row['Nurse_contact'];?>
												<td><?php echo $row['username'];?>
												</td>
												
												<td >
												<div class="visible-md visible-lg hidden-sm hidden-xs">
							<a href="edit_nurse.php?id=<?php echo $row['id'];?>" class="btn btn-transparent btn-xs" tooltip-placement="top" tooltip="Edit"><i class="fa fa-pencil"></i></a>
