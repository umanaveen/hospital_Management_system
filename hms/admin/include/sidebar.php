						...
						<ul class="main-navigation-menu">
							...
							<li>
								...
								<ul class="sub-menu">
									...
									<li>
										<a href="doctor_day_time.php">
											<span class="title"> Add Doctor Day and time </span>
										</a>
									</li>
								</ul>
								</li>
								...
								<ul class="sub-menu">
								<li>
										<a href="nurse-specilization.php">
											<span class="title"> Nurse Specialization </span>
										</a>
									</li>
									<li>
									...
									<li>
										<a href="view_nurse.php">
											<span class="title"> View Nurse </span>
										</a>
									</li>
	...
	<li>
				...
				<li>
								...
								<ul class="sub-menu">
									...
									<li>
										<a href="Msicreport.php">
											<span class="title">MSIC REPORT </span>
										</a>
									</li>
